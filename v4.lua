...
AddScript.MouseButton1Click:Connect(function()
    ...
    if not ScriptNm or not ScriptAuth or not ScriptSrc then return end
    Scripts:GetScripts()
    ...
    local Success = pcall(function()
        writefile("scripts.wizardhub", game:GetService("HttpService"):JSONEncode(Scripts.Table))
    end)
    if Success then
        Scripts:GetScripts()
        Scripts:Query("")
